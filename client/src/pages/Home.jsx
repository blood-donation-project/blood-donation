    ...
    return (
        <>
            ...
            <div className="flex-center mt-[56px] bg-[#f0f2f5] ">
                {/* Sidebar left */}
                <div className="w-[360px] h-screen py-3 fixed left-0 top-[56px]">
                    <div className="pl-2 grid">
                        <Link className="flex items-center hover:bg-[#ebebeb] pl-2 py-1.5 rounded-l-md" to="/">
                            <div>
                                <img
                ...
                <div className="w-full max-w-[calc(100vw-_720px)] flex  flex-col items-center py-3 px-4  ">
                    {/* Div đăng bài */}
                ...
                <div className="w-[360px] h-screen  py-3 fixed top-[56px] right-0">
                    {/* List bạn bè  */}
                    <div className="pb-1 border-b border-b-[#ccc]">
                        ...
                        <div className=" py-2 pl-2 grid">
                            <Link className="flex items-center hover:bg-[#ebebeb] pl-2 py-1.5 rounded-md" to="/">
                                <div>
                                    <img
                                        className="w-9 h-9 rounded-[50%] border border-[#ccc]"
