...
const ChatHeader = () => {
    ...
    return (
        <div className="border-b shadow-lg">
            <div className="chat-header px-6 py-2 flex flex-row  justify-between items-center ">
                <Link to={`/user/${userProfile?._id}`} className="flex hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
