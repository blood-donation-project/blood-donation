                        ...
                        <div className="px-4 h-[calc(100%_-_50px)] overflow-y-scroll">
                            <form className="w-full mx-[auto]" onSubmit={handleSubmit(handleSubmitForm)}>
                                ...
                                <div className="md:flex-row xs:flex-col w-full flex justify-between mb-3">
                                    ...
                                    <div
                                        className={`${user?.identification ? '' : 'flex justify- gap-2 items-center'} xs:w-full md:w-[45%] xs:mt-2 md:mt-0`}
                                    >
                                        ...
                                        {user?.identification ? (
                                            ...
                                            <IoMdAddCircle
                                                ...
                                                className="w-6 h-6 text-green-400 cursor-pointer hover:text-green-500"
                                            />
                                        )}
                                    </div>
                                </div>
